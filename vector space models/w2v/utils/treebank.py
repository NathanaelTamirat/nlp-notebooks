...
class StanfordSentiment:
    def __init__(self, path=None, tablesize = 1000000):
        if not path:  # if no path is provided, it sets a default path
            path = "/home/nathanael/Desktop/build/nlp/vector space models/w2v/utils/datasets/stanfordSentimentTreebank"
        self.path = path
    ...
    def tokens(self):
        ...
        If a word is new, it assigns it an index and 
        initializes its frequency
        If a word is already known, it increments its frequency
        '''
        ...
        tokens["UNK"] = idx  #add an "UNK" (unknown) token to handle unseen words
        revtokens += ["UNK"]
        tokenfreq["UNK"] = 1
        wordcount += 1
    ...
    '''
    It skips the first line (assuming it's a header)
    It splits each line into words, converts them to lowercase,
    and adds them to the sentences list
    '''
    def sentences(self):
        ...
        with open(self.path + "/datasetSentences.txt", "r") as f:
            first = True
            # /home/nathanael/Desktop/build/nlp/vector space models/w2v/utils/datasets/stanfordSentimentTreebank/datasetSentences.txt
            for line in f:
                if first:
                    first = False
                    continue
